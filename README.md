...
| `Delete Vehicle` | Remove the vehicle you're aiming at |
...
| `Round Timer` | Start a round timer that automatically resets LIVE when it expires |
| `Cancel Round Timer` | Cancel an active round timer without affecting LIVE |
